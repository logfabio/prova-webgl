...
import logo from "../assets/image/logoKeytech.jpg";
    ...
    <PDFViewer width={600} height={800}>
      <Document>
        <Page style={styles.body}>
          ...
          <Text style={styles.title}>Sede, gg/mm/aaaa</Text>
          <Text style={styles.subtitle}>
            OGGETTO: RICHIESTA DI AUTORIZZAZIONE A VIAGGIO CON WELFARE EMIGRATIS
          </Text>
          <Text style={styles.author}>Il/la sottoscritto/a</Text>
          <Text style={styles.author}>Nome Cognome</Text>
